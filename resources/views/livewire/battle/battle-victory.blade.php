<div class="fixed inset-0 flex items-center justify-center bg-blue-950 border-8 border-yellow-400 z-50">
    <div class="text-center flex flex-col items-center">
        ...
        <button wire:click="finishGame" class="bg-gradient-to-b from-yellow-300 to-red-800 text-blue-950 px-10 py-4 rounded-lg font-bold text-xl uppercase tracking-wider transition-all transform hover:scale-105">
            Return to menu
        </button>
